...
import com.example.rental.dao.Order.OrderBeginDao;
...
@Service
public class OrderBeginServiceImpl implements OrderBeginService {
    @Autowired
    ...
    public Result getOrderByConsumerId(String consumer_id) {
        List<Map<String, Object>> Orders = orderBeginDao.getOrderByConsumerId(consumer_id);
    ...
    public Result getOrderByLandlordId(String landlord_id) {
        List<Map<String, Object>> Orders = orderBeginDao.getOrderByLandlordId(landlord_id);
        boolean ordersFound = processOrderDetails(Orders);
